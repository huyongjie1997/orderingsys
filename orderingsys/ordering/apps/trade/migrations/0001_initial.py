    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_num', models.IntegerField(default=0, verbose_name='商品数量')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='food.Food', verbose_name='商品')),
            ],
            options={
                'verbose_name': '订单商品',
